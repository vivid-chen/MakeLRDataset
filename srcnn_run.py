...
parser.add_argument('--input_image', type=str, default = '/media/lab1008/A2FE99FDBDECF1EA/CZY/MakeLRDataset/dataset/RealSR/images/HR/001', help='input image to use')
...
parser.add_argument('--output_filename', type=str, default = '/media/lab1008/A2FE99FDBDECF1EA/CZY/MakeLRDataset/dataset/RealSR/images/LR/001', help='where to save the output image')
